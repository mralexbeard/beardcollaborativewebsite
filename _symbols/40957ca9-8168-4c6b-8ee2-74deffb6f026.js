...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-oj21ff");
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button svelte-oj21ff");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(hr, "class", "svelte-oj21ff");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-oj21ff");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-oj21ff");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-oj21ff");
			set_style(a, "--size", style___size);
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(button, "class", "svelte-oj21ff");
			attr(nav, "class", "svelte-oj21ff");
			attr(div0, "class", "desktop-nav svelte-oj21ff");
			attr(div1, "class", "section-container svelte-oj21ff");
			attr(header, "class", "svelte-oj21ff");
		},
		m(target, anchor) {
